...
ex = xval2[:-1]
plt.bar(ex,rd[0],width=ww*0.7,color=farbe[0],edgecolor='black',align='center',label=lbl[0])
plt.bar(ex,rd[2],width=ww,color=farbe[2],edgecolor='black',align='center',label=lbl[2])
plt.bar(ex,rd[1],width=ww*0.85,color=farbe[1],edgecolor='black',align='center',label=lbl[1])
plt.bar(ex[mask1[:,0]],rd[2,mask1[:,0]],width=ww[mask1[:,0]],color=farbe[2],edgecolor='black',align='center')
plt.bar(ex[1:3],rd[1,1:3],width=ww[1:3]*0.85,color=farbe[1],edgecolor='black',align='center')
plt.bar(ex[5],rd[1,5],width=ww[5]*0.85,color=farbe[1],edgecolor='black',align='center')
...
for i in np.arange(3):
    ...
    print(x.shape,y.shape,field[i].shape)
    cpc1 = carte.pcolor(x,y,(np.transpose(field[i])),cmap=coul[i])   # shading='flat',
