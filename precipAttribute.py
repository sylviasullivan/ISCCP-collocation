...
# load CT data
datei  = "/rigel/home/scs2229/top-secret/MCS_clim/data/ISCCP/CT-allDataFilteredEdges.npy"
...
for ii in range(len(yrs)):
    ...
    print(len(toomuch))
    print(basedir + 'ATT_' + str(yrs[ii]) + mon[ii] + '_3h_CG_nofrac.npy') 
    np.save(basedir + 'ATT_' + str(yrs[ii]) + mon[ii] + '_3h_CG2_nofrac.npy',precatt)
